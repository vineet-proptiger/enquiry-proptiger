    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        ...
        >
          ...
          <span style={{ fontSize: '9px', fontWeight: '600', letterSpacing: '0.04em' }}>Call Us</span>
        </a>
        <button
          onClick={() => setIsOpen(true)}
          className="flex-1 flex flex-col items-center justify-center gap-0.5 py-2 text-white"
          style={{ background: '#EB2027' }}
        >
        ...
        >
          ...
          <span style={{ fontSize: '9px', fontWeight: '600', letterSpacing: '0.04em' }}>WhatsApp</span>
        </a>
      </div>
