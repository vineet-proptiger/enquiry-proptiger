...
import { masterplanImages } from '../../lib/raghava/images'
...
const plans = [
  ...
  { label: '3 BHK (The Essential) — 1,800 Sq.ft.',     img: masterplanImages.bhk2 },
  { label: '3 BHK (The Signature) — 2,275 Sq.ft.',     img: masterplanImages.bhk3 },
  { label: '3 BHK (The Sky Home) — 2,455 Sq.ft.',      img: masterplanImages.bhk45 },
]
    ...
    <section id="masterplan" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>Hyderabad — Layout & Configuration</span>
          <h2 style={{
