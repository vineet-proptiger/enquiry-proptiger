...
// import { popupImage } from '../../lib/raghava/images'
    ...
    >
      ...
      >
        ...
        {/* <div className="hidden sm:block sm:w-[44%] shrink-0 relative" style={{ background: '#0d1117', minHeight: '100%' }}>
          <Image src={popupImage} alt="Raghava Halo Hyderabad" fill className="object-cover" sizes="(max-width: 768px) 0vw, 45vw" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 text-white z-10">
            <p className="text-[10px] font-semibold tracking-[3px] uppercase opacity-80 mb-1" style={{ fontFamily: F_SANS, color: 'var(--color-teal)' }}>Raghava Halo — Hyderabad</p>
            <p style={{ fontFamily: F_JOST, fontSize: '13px', fontWeight: 500, opacity: 0.85 }}>3 BHK · Starting ₹1.6 Cr*</p>
          </div>
        </div> */}
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          {/* <div className="sm:hidden w-full h-56 relative shrink-0">
            <Image src={popupImage} alt="Raghava Halo Hyderabad" fill className="object-cover" style={{ objectPosition: 'top' }} sizes="100vw" />
            ...
            <div className="absolute bottom-3 left-4 text-white z-10">
              <p className="text-[9px] uppercase tracking-[2px] opacity-80" style={{ fontFamily: F_SANS }}>Raghava Halo — Hyderabad</p>
              <p className="text-[11px] font-medium opacity-85" style={{ fontFamily: F_JOST }}>3 BHK · Starting ₹1.6 Cr*</p>
            </div>
          </div> */}
