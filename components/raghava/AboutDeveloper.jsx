  ...
  <section id="developer" className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="text-center mb-10" data-aos="fade-up">
        ...
        }}>Raghava Projects — Developer Profile</span>
        <h2 style={{
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch max-w-6xl mx-auto">
        ...
        <div style={{
          ...
          boxShadow: '0 4px 24px rgba(184,149,106,0.1)',
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              Raghava Projects is re-imagining high-rise luxury living in Hyderabad by building homes around real human lives rather than mere surface aesthetics. While others focus on marble and gold leaf, Raghava obsesses over the everyday experiences that truly matter — from the natural light flooding your kitchen to effortless vertical transit and expansive balconies. Raghava Halo is our premier 52-storey luxury landmark offering 3 BHK high-rise residences across a 5.5-acre gated community in Hyderabad, setting a new benchmark for thoughtful urban engineering and timeless comfort.
            </p>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                { value: '5.5', label: 'Acres Gated Community' },
                { value: '52', label: 'Storeys High-Rise Towers' },
                { value: '90,000 Sft', label: 'Wellness Clubhouse' },
              ].map((stat, i) => (
                <div key={i} style={{
