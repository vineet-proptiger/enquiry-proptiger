...
import { PROJECT_ID, PROJECT_NAME, API_ENDPOINT, SHEET_NAME, SECRET_KEY, CITY_DISPLAY } from '../../lib/raghava/config'
import { buildTrackingFields } from '../../lib/formMeta'
import { overviewImage } from '../../lib/raghava/images'
...
const PREVIEW_TEXT = `Raghava Halo is an upcoming premium high-rise residential landmark in Hyderabad. Three towers. Fifty-two floors. Over a thousand homes built around one powerful idea — that real luxury isn't just the chandelier in the lobby. It is a home that works, effortlessly, every single day.`

const MORE_TEXT = ` Anyone can add marble and gold leaf, but fewer developers obsess over the things you actually feel at 8am on a Tuesday — the natural light in your kitchen, the wait for a lift, and the width of the balcony you drink your coffee on. Raghava Halo was designed the other way around. We started with how you live, then built the architecture to serve it across a 5.5-acre gated community featuring an expansive 90,000 SFT Wellness Clubhouse.`
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        ...
        <div data-aos="fade-right" style={{ display: 'flex' }}>
          ...
          >
            <Image src={overviewImage} alt="Raghava Halo Hyderabad" fill className="object-cover object-top"
